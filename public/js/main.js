!(function (e) {
  'use strict';
   $('#slider_appointment_form').draggable({
     containment: 'parent',
   });
  ...
  e('.multi-side-hover').each(function () {
    ...
    e('nav#dropdown').meanmenu({
      siteLogo:
        "<div class='mobile-menu-nav-back d-flex'><a class='logo-mobile' href='index.html'><img src='img/tilhangalogo.png' alt='logo' class='img-fluid'/></a><a class='logo-mobile' href='#'><img src='img/who-logo.png' alt='logo' class='img-fluid'/></a></div>",
    }),
