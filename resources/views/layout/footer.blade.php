<footer>
          ...
          <div class="single-item col-lg-4 col-md-4 col-12">
            <div class="footer-box">
              <div class="footer-logo">
                <a href="index.html"
                  ><img src="" class="img-fluid" alt="footer-logo"
                /></a>
              </div>
              <div class="footer-about">
                <p>
                  We are ipsum dolor sit amet aeeatt consectetuer adipiscing
                  elitseder diam nonummy.
                </p>
              </div>
              <div class="footer-contact-info">
                <ul>
                  <li>
                    <i class="fas fa-map-marker-alt"></i>Gaushala, Kathmandu
                  </li>
                  <li><i class="fas fa-phone"></i>+977 123123131888555</li>
                  <li>
                    <i class="far fa-envelope"></i
                    ><a href="">RSU@tilganga.org</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <section class="footer-bottom-wrap">
      <div class="copyright">
        Copyright @ 2022 Refractive Surgery Unit. All Rights Reserved.
      </div>
    </section>
  </footer>